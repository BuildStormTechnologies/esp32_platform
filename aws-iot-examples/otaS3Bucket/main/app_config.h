...
#define DEFAULT_LOG_LEVELS {                                                      \
    ...
    PRINT_LEVEL_INFO,  /* LIB_MODULE_WIFI      */                                 \
    ...
    PRINT_LEVEL_INFO   /* APP_MODULE_MAIN  **Add application modules from here */ \
};

//-------------------------APP CONFIG--------------------------/
#define TASK_APP_PRIORITY 4
#define TASK_APP_STACK_SIZE (6 * 1024) // reduce it to 4096

#define APP_VERSION "v2.0.3"
...
#define AWS_PROVISION_TEMPLATE_NAME "test1_fleet_prov_template"

#define PUB_TOPIC "testPub/ESP32"
#define SUB_TOPIC "testSub/ESP32"
