...
static const uint8_t ST7789V_init[] = {
    ...
    TFT_CMD_SWRESET,
    TFT_CMD_DELAY, //  1: Software reset, no args, w/delay
    200,           //     200 ms delay
#endif
    TFT_CMD_FRMCTR2,
    5,
    ...
    TFT_MADCTL,
    1,
    (MADCTL_MX | TFT_RGB_BGR), // Memory Access Control (orientation)
    TFT_CMD_PIXFMT,
    1,
    DISP_COLOR_BITS_24, // *** INTERFACE PIXEL FORMAT: 0x66 -> 18 bit; 0x55 -> 16 bit
    TFT_CMD_SLPOUT,
    TFT_CMD_DELAY,
    120, //  Sleep out,	//  120 ms delay
    TFT_DISPON,
    TFT_CMD_DELAY,
    120,
};
...
static const uint8_t ILI9341_init[] = {
    ...
    0x86, //VCM control2
    TFT_MADCTL,
    1, // Memory Access Control (orientation)
    ...
    TFT_CMD_3GAMMA_EN,
    1,
    0x00, // 3Gamma Function: Disable (0x02), Enable (0x03)
    TFT_CMD_GAMMASET,
    1,
    0x01, //Gamma curve selected (0x01, 0x02, 0x04, 0x08)
    TFT_CMD_GMCTRP1,
    15, //Positive Gamma Correction
    0x0F,
    0x31,
    0x2B,
    0x0C,
