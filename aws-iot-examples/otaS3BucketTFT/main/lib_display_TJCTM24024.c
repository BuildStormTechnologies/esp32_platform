...
void DISP_welcomeScreen()
{
    ...
    TFT_printWithColor("ESP32", CENTER, y, TFT_LIGHTGREY, TFT_BLACK);                 //DEJAVU24_FONT // 20 char/line
    TFT_printWithColor("OTA Update With", CENTER, y + offset, TFT_LIGHTGREY, TFT_BLACK); //DEJAVU24_FONT // 20 char/line
    TFT_printWithColor("AWS jobs & S3 Bucket", CENTER, y + 2 * offset, TFT_LIGHTGREY, TFT_BLACK);     //DEJAVU24_FONT // 20 char/line
...
void DISP_init()
{
    ...
    disp_varInit();
    disp_header("AWS IOT OTA DEMO", "BuildStorm Technologies");
    DISP_welcomeScreen();
